...
@section('content')
 ...
 <textarea id="mytextarea" class="richTextBox" name="body">{{ old('body' , $dataTypeContent->body ?? '') }}</textarea>
                ...
                <div class="col-md-4">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group" style="display:none">
                                ...
                                <select class="form-control" name="status">
                                    <option value="PUBLISHED"  selected="selected" @if(isset($dataTypeContent->status) && $dataTypeContent->status == 'PUBLISHED') selected="selected"@endif>{{ __('voyager::post.status_published') }}</option>
                    ...
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            @endif
                            <input type="hidden" name="imageexist" id="imageexist" value="{{ Voyager::image($dataTypeContent->image) ? 1 : 0 }}" >
                    ...
                    <div class="panel panel-bordered panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="seo_title" placeholder="SEO Title" value="{{ old('seo_title', $dataTypeContent->seo_title ?? '' )}}">
                            </div>
                        </div>
                    </div>
                </div>
